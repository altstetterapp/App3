...
const PLANT_IMG = {
  rosmarin:  window.__resources.img_rosmarin,
  erdbeere:  window.__resources.img_erdbeere,
  tomate:    window.__resources.img_tomate,
  basilikum: window.__resources.img_basilikum,
  mangold:   window.__resources.img_mangold,
  salbei:    window.__resources.img_basilikum,
  minze:     window.__resources.img_minze,
  thymian:   window.__resources.img_rosmarin,
  chili:     window.__resources.img_chili,
};
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: '#fff', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        height: `${(RP.density.sheetH || 0.58) * 100}%`,
        background: RP.bg,
...
Object.assign(window, { Screen1, Screen2, Screen3, Screen4, Phone, RP });
